...
export type PluginStats = Record<string, Record<string, {
...
export declare class Compiler {
    ...
    modules(): import("../index.js").Module[];
    getResolveRecords(id: string): import("../types/binding.js").ResolveRecord[];
    getTransformRecords(id: string): import("../types/binding.js").TransformRecord[];
    getProcessRecords(id: string): import("../types/binding.js").ModuleRecord[];
    getAnalyzeDepsRecords(id: string): import("../types/binding.js").AnalyzeDepsRecord[];
    getResourcePotRecordsById(id: string): import("../types/binding.js").ResourcePotRecord[];
}
